...
:page-aliases: anypoint-studio-5.4-with-3.7.3-runtime-release-notes.adoc
...
Studio now includes graphical mapping capabilities for xref:3.7@mule-runtime::dataweave.adoc[DataWeave], allowing you to easily perform drag and drop mappings, with all the power of the DataWeave runtime. As you construct the mapping, the DataWeave code and your output preview are dynamically built, allowing you to see the results as you progress.

image::studio/dw-new-mapping.png[dw mapping]

=== DataMapper to DataWeave Migration Assistant

For xref:5@studio::datamapper-user-guide-and-reference.adoc[DataMapper] users, a migration tool is now included in Studio, which will assist users in converting their maps to xref:3.7@mule-runtime::dataweave-reference-documentation.adoc[DataWeave Scripts]. Users can right click on DataMapper, select Migrate to DataWeave, and follow the instructions.

image::studio/dw-migrator-script.png[dw migrator]
...
image::studio/new-studio-theme.png[studio theme]
...
image::studio/pallete-new-look.png[new look]
...
* xref:1.3@munit::index.adoc[MUnit] is now included out of the box in Studio, making it easier to get started testing your Mule applications.
* Many bug fixes
