...
* MUnit now can run multiple suites, and allow https://docs.archive.mulesoft.com/munit/v/1.2/using-munit-in-anypoint-studio#running-a-tests-inside-a-folder[nested folders for tests]. Users can also now create MUnit https://docs.archive.mulesoft.com/munit/v/1.2/munit-maven-support#coverage[coverage reports from inside Studio]. We have also added autocompletion support for MUnit’s MEL functions and metadata support to MUnit message processors
...
*** Implementing a xref:3.x@apikit::apikit-tutorial.adoc#creating-a-new-project[REST API] / xref:3.x@apikit::apikit-for-soap.adoc#creating-a-new-project[SOAP API] /
