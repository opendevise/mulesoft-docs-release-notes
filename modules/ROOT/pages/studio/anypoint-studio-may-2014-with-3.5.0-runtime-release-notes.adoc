...
:page-aliases: anypoint-studio-may-2014-with-3.5.0-runtime-release-notes.adoc
...
|===
|Issue |Description
|n/a |xref:3.7@mule-runtime::batch-processing.adoc[Batch processing] does not support the use of link:/mule-management-console/v/3.7/migration-scripts-for-business-events[Business Events].
