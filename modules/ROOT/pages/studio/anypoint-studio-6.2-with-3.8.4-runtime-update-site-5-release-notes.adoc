= Anypoint Studio 6.2 with 3.8.4 Update Site 5 Runtime Release Notes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-aliases: anypoint-studio-6.2-with-3.8.4-runtime-update-site-5-release-notes.adoc
...
In this release, we focused on bug fixes for xref:studio/anypoint-studio-6.2-with-3.8.4-runtime-update-site-4-release-notes.adoc[Anypoint Studio 6.2.4].
