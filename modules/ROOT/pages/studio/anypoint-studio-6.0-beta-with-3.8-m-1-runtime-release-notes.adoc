...
:page-aliases: anypoint-studio-6.0-beta-with-3.8-m-1-runtime-release-notes.adoc
...
* Support for xref:mule-runtime/mule-runtime-3.8.0-m1-release-notes.adoc[Mule 3.8], which unifies the API Gateway runtime with the core Mule runtime, adds additional TLS capabilities, additional tuning parameters for batch, and improved error messages.
...
image::studio/studio-apiplat-integration.png[api]


image::studio/studio-apiplat-integration2.png[api]
...
image::studio/studio-new-console.png[console]

=== And more

* Support for reading and writing fixed width and other flat files using DataWeave.
* Users can now browse for WSDLs in the exchange and when configuring the WS Consumer.
* Support for xref:mule-runtime/mule-runtime-3.8.0-m1-release-notes.adoc[Mule 3.8], which creates a single unified runtime for API gateways and integrations, adds additional TLS capabilities, additional tuning parameters for batch, and improved error messages.
