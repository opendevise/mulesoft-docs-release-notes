...
. xref:runtime-manager::managing-servers.adoc#add-a-server[Register] your Mule Runtime instances in Runtime Manager (using the same names these had in MMC). For details on how to do this, see xref:runtime-manager::installing-and-configuring-runtime-manager-agent.adoc[installing and configuring Mule Agent]
