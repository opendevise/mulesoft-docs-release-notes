...
:page-aliases: migrating-mule-2.x-ce-to-ee.adoc
...
. Install `mule-<version>-EE` into a new directory (see xref:3.7@mule-runtime::installing.adoc[Installing Mule]). Do not overwrite your existing Mule Community installation.
