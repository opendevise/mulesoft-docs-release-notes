...
:page-aliases: mule-esb-3.6.3-release-notes.adoc
...
|Software |*Version*
|*ESB Runtime* |3.6.3
|*Anypoint Studio* |xref:studio/anypoint-studio-march-2015-with-3.6.1-runtime-update-site-2-release-notes.adoc[Anypoint Studio March 2015 with 3.6.1 Runtime - Update Site 2 Release Notes]
|*MMC* |3.6.0
|*Anypoint DevKit* |xref:connector-devkit/anypoint-connector-devkit-3.6.1-release-notes.adoc[Anypoint Connector DevKit 3.6.1 Release Notes]
...
MULE-8571 also introduced hostname validation in the HTTP requester since the upgrade included the fix for https://github.com/AsyncHttpClient/async-http-client/issues/197[this] async-http-client security vulnerability. This means that seemingly valid certificates for HTTPS connections in older versions could now be rejected if they contain no Subject Alternative Name extension matching the host of the request.
...
* http://forums.mulesoft.com/[MuleSoft’s Forum]
* https://www.mulesoft.com/lp/dl/mule-esb-enterprise[Anypoint Studio]