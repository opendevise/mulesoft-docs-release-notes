...
:page-aliases: mule-esb-3.5.3-release-notes.adoc
...
|*MMC* |<<MMC 3.5.3 Fixes>>
|*Anypoint DevKit* |xref:connector-devkit/anypoint-connector-devkit-3.5.2-release-notes.adoc[3.5.2]
|*APIkit* |1.5.0
|===
...
* For details on Anypoint Studio October 2014 release (that comes with 3.5.3 Runtime), see the xref:studio/anypoint-studio-october-2014-release-notes.adoc[Anypoint Studio October 2014 Release Notes].
