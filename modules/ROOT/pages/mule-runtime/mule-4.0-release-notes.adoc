...
== What’s new?
This release contains only bug fixes. See xref:4.1@mule4-runtime::mule-runtime-updates.adoc[What’s New in Mule 4] for a complete overview of what’s included in Mule 4.

== Gateway 4
Gateway leverages many of the improvements added in Mule 4. See xref:4.1@mule4-runtime::mule-runtime-updates.adoc[What’s New in Mule 4] for a complete overview.
