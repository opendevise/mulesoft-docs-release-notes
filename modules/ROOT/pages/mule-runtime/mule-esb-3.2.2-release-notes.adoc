...
:page-aliases: mule-esb-3.2.2-release-notes.adoc
...
|MULE-5820 |Core: Endpoints |Invocation-scoped properties are lost after processing a request-response endpoint
...
For instructions on migrating from a previous version, consult the xref:deprecated/legacy-mule-migration-notes.adoc[Migration Guide].
