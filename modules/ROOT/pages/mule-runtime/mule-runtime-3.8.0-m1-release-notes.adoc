...
* This release unifies the xref:1.x@api-manager::api-gateway-runtime-archive.adoc[API Gateway runtime] with the core Mule runtime, simplifying development and operations. Please see the xref:api-gateway/api-gateway-runtime-to-mule-3.8.0-migration-guide.adoc[migration guide] for information on how to migrate.
