...
:page-aliases: mule-runtime-3.8.0-m1-release-notes.adoc
...
* This release unifies the link:/api-manager/api-gateway-runtime-archive[API Gateway runtime] with the core Mule runtime, simplifying development and operations. Please see the xref:api-gateway/api-gateway-runtime-to-mule-3.8.0-migration-guide.adoc[migration guide] for information on how to migrate.
...
* Includes the new xref:3.8@mule-runtime::dataweave.adoc[DataWeave] release, which contains support for flat files and performance improvements.
* New functionality for configuring the use of xref:3.8@mule-runtime::creating-and-managing-a-cluster-manually.adoc[clusters]. This Includes:
...
When migrating from an API Gateway Runtime, follow this xref:api-gateway/api-gateway-runtime-to-mule-3.8.0-migration-guide.adoc[migration guide].
...
* xref:api-gateway/api-gateway-runtime-to-mule-3.8.0-migration-guide.adoc[migration guide]
