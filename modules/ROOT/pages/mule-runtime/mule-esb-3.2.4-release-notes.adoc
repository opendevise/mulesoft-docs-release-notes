...
:page-aliases: mule-esb-3.2.4-release-notes.adoc
...
The improvements and fixes that Mule ESB 3.2.4 introduces require no specific migration activities for Mule ESB. For more details on how to migrate from previous versions of Mule ESB, access the xref:deprecated/legacy-mule-migration-notes.adoc[library of Migration Guides].
