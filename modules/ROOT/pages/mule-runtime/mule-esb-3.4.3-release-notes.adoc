...
:page-aliases: mule-esb-3.4.3-release-notes.adoc
...
* xref:5@studio::installing-extensions.adoc[Add 3.4.3 runtime to your Mule Studio instance]
...
For most use cases, Mule ESB 3.4.3 does not change the xref:3.7@mule-runtime::hardware-and-software-requirements.adoc[hardware and software system requirements] established by Mule ESB 3.4.1.  https://www.mulesoft.com/contact[Contact MuleSoft] with any questions about system requirements.
...
* Access {site-url}[MuleSoft Docs].
* Access MuleSoft’s http://forums.mulesoft.com/[Forum] to pose questions and get help from Mule’s broad community of users.
* To access MuleSoft’s expert support team, https://www.mulesoft.com/support-and-services/mule-esb-support-license-subscription[subscribe] to Mule ESB Enterprise Edition and log in to MuleSoft’s http://www.mulesoft.com/support-login[Customer Portal].