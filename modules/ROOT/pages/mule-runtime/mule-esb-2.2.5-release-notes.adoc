...
:page-aliases: mule-esb-2.2.5-release-notes.adoc
...
To find out more about the Mule Management Console release version 2.2.5, please see the xref:deprecated/legacy-mule-release-notes.adoc[Release Notes] and the Mule Management Console link:/mule-management-console/v/3.7[Home] page.
