...
The Mule team is proud to announce the availability of Mule ESB 3.1.2. This is a follow-up release to xref:mule-runtime/mule-esb-3.1.1-release-notes.adoc[Mule ESB 3.1.1], which continues MuleSoft's commitment to making Mule the industry's most powerful, simplest to use, and up-to-date Open Source ESB. **Over 60 issues were fixed between this release and the previous one, making this release a highly recommended download and more stable version**.
...
You can read more details about this on https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/logging-with-mule-esb-3.x[Logging with Mule ESB 3.X].
...
For instructions on migrating from a previous version, consult the https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/[Mule documentation page].
...
Mule version 3.1.2 builds on the features added in xref:mule-runtime/mule-esb-3.1.1-release-notes.adoc[version 3.1.1] and fixes the following issues.
