...
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/ajax-transport-reference[AJAX Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/bpm-transport-reference[BPM Module Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/email-transport-reference[Email Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/file-transport-reference[File Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/ftp-transport-reference[FTP Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/imap-transport-reference[IMAP Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/multicast-transport-reference[Multicast Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/pop3-transport-reference[POP3 Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/sftp-transport-reference[SFTP Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/smtp-transport-reference[SMTP Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/ssl-and-tls-transports-reference[SSL and TLS Transports Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/tcp-transport-reference[TCP Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/udp-transport-reference[UDP Transport Reference]
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/xmpp-transport-reference[XMPP Transport Reference]
...
* https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/mule-high-availability[Limitations to High Availability]
