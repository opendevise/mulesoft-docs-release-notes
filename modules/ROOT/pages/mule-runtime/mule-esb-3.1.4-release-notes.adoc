...
:page-aliases: mule-esb-3.1.4-release-notes.adoc
...
|MULE-5820  |Invocation-scoped properties are lost after processing a request-response endpoint
...
The improvements and fixes that Mule ESB 3.1.4 introduces require no specific migration activities for Mule ESB. For more details on how to migrate from previous versions of Mule ESB, access the xref:deprecated/legacy-mule-migration-notes.adoc[library of Migration Guides].

== Support Resources

Please refer to the following resources for assistance using Mule ESB 3.1.4.

* Access MuleSoft’s http://forums.mulesoft.com/[MuleSoft forum] to pose questions and get help from Mule’s broad community of users.
