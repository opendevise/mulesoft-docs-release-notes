...
:page-aliases: mule-4.1.3.2-release-notes.adoc
:keywords: mule, 4.1.3.2, runtime, release notes

*August 14, 2018*

http://s3.amazonaws.com/new-mule-artifacts/mule-ee-distribution-standalone-4.1.3.2.zip[Download Mule 4.1.3.2 EE Distribution]
