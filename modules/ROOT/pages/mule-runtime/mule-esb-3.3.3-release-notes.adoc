...
:page-aliases: mule-esb-3.3.3-release-notes.adoc
...
* *Support for multiple runtimes* *in Studio* - Beyond the Community runtime, you can download multiple Enterprise runtimes in Studio, using different runtimes with your Studio projects as desired.  Read more about xref:5@studio::installing-extensions.adoc[installing extra runtimes in Studio].
