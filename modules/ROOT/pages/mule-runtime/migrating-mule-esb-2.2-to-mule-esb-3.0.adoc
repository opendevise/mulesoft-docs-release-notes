...
:page-aliases: migrating-mule-esb-2.2-to-mule-esb-3.0.adoc
...
* The ForwardingConsumer and SelectiveConsumer inbound routers are still supported but have been deprecated. You can no longer use the ForwardingConsumer to selectively skip the component, you should do this with a xref:3.7@mule-runtime::using-interceptors.adoc[component interceptor] instead.
...
Exception strategies have been revamped for 3.0. xref:3.7@mule-runtime::error-handling.adoc[See documentation]

== Reconnection Strategies (ex-Retry Policies)

Retry Policies have been renamed to Reconnection Strategies for 3.1 to avoid misunderstandings. xref:3.7@mule-runtime::configuring-reconnection-strategies.adoc[See documentation]
...
More details in the xref:3.7@mule-runtime::tuning-performance.adoc[Tuning Performance] documentation.
