...
* xref:5@studio::installing-extensions.adoc[Add 3.4.2 runtime to your Mule Studio instance]
...
For most use cases, Mule ESB 3.4.2 does not change the xref:3.7@mule-runtime::hardware-and-software-requirements.adoc[hardware and software system requirements] established by Mule ESB 3.4.1. https://www.mulesoft.com/contact[Contact MuleSoft] with any questions you may have about system requirements.
...
* Access https://docs.archive.mulesoft.com/mule-management-console/v/3.4/[MMC 3.4 docs].
* See Also: https://docs.archive.mulesoft.com/mule-management-console/v/3.7/encrypting-ldap-and-database-passwords-in-mmc[Encrypting LDAP and Database Passwords in MMC]