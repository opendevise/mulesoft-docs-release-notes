...
:page-aliases: mule-esb-3.6.1-release-notes.adoc
...
This release fixes the HTTP Connector security issue described in xref:connector/http-connector-security-update.adoc[this release bulletin].
