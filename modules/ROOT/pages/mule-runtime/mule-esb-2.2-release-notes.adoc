...
:page-aliases: mule-esb-2.2-release-notes.adoc
...
Mule Enterprise 2.2 includes many new features and fixes developed on Mule Community Edition. For a list of these fixes, see xref:deprecated/legacy-mule-release-notes.adoc[Mule 2 Release Notes].
