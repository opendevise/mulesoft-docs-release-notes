...
:page-aliases: mule-esb-3.3.0-release-notes.adoc
...
Mule ESB 3.3 resolves several issues involving message properties and includes two improvements. Refer to link:/mule-user-guide/v/3.3/transformer-reference[Transformers] documentation for further details on Mule Studio’s new transformers.
