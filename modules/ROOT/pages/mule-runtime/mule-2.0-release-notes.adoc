...
The {site-url}[documentation] is well underway. This user guide includes XML configuration documentation which is auto-generated from the core, module and transport schemas.
...
This release includes for the first time the Mule CXF Transport which is an evolution of Mule's XFire Transport for web service integration via http://cxf.apache.org/[Apache CXF].
...
First take a look at the https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/about-mule-configuration[Mule 2.0 Configuration Guide] to see how a 2.0 Mule config compares to a 1.4 config.

For those interested in creating an XML Namespace for their custom module/transport (or just want to know the gory details of how it works), read https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/creating-a-custom-xml-namespace[How to Create an XML Namespace].
