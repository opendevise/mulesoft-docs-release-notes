...
:page-aliases: mule-esb-3.7.1-release-notes.adoc
...
For further technical details, you can read the full spec at https://github.com/mulesoft/mule/wiki/[Mule-3.7.0-M1%5D-Registry-Consolidation,-Lifecycle-fix,-and-Dependency-Injection]
