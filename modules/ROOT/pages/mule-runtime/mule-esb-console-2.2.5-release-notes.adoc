...
* Migrating the early access 2 (EA2) release to the current GA 2.2.5 release. This migration requires extra steps. See also the https://docs.archive.mulesoft.com/mule-user-guide/v/3.2/troubleshooting[Troubleshooting Tips].
