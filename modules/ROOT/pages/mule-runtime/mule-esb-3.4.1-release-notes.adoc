...
* xref:5@studio::installing-extensions.adoc[Add 3.4.1 runtime to your Mule Studio instance] +
...
For most use cases, Mule ESB 3.4.1 does not change the xref:3.7@mule-runtime::hardware-and-software-requirements.adoc[hardware and software system requirements] established by Mule ESB 3.4.0.
...
Copy the configuration from the previously backed up files. Look at https://docs.archive.mulesoft.com/mule-management-console/v/3.3/persisting-environment-data[this guide] to determine the list of changes you need to copy over. Do not override the files with the old ones. Only jackrabbit-repo.xml can be safely overwritten.
...
You need to copy the configuration from the previously backed up files. Look at https://docs.archive.mulesoft.com/mule-management-console/v/3.3/persisting-transaction-data[this guide] to determine the list of changes you need to copy over. Do not override the files with the old ones. Only jackrabbit-repo.xml can be safely overwritten.
