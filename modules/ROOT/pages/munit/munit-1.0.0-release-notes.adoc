...
:page-aliases: munit-1.0.0-release-notes.adoc
...
* https://www.mulesoft.org/jira/browse/MU-262[MU-262]: ForEach loop cannot transform back from XML
* https://www.mulesoft.org/jira/browse/MU-352/[MU-352]: Problem with duplicated transformers in classpath when running a test
