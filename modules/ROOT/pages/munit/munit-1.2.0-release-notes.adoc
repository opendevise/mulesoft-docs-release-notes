...
* Multiple Suite Run
* MUnit https://docs.archive.mulesoft.com/munit/v/1.2/using-munit-in-anypoint-studio#running-a-tests-inside-a-folder[Nested Folders]
* Create https://docs.archive.mulesoft.com/munit/v/1.2/munit-maven-support#coverage[Coverage Reports from inside Studio]
...
* https://docs.archive.mulesoft.com/munit/v/1.2/[MUnit Documentation]
* https://docs.archive.mulesoft.com/munit/v/1.1/[MUnit 1.1 Documentation]
* https://docs.archive.mulesoft.com/munit/v/1.0/[MUnit 1.0 Documentation]
