...
:page-aliases: api-gateway-2.2.0-release-notes.adoc
...
* xref:api-gateway/api-gateway-2.1.0-release-notes.adoc[API Gateway Runtime 2.1.0 Release Notes]
* xref:api-gateway/api-gateway-2.0-release-notes.adoc[API Gateway 2.0 Release Notes].
