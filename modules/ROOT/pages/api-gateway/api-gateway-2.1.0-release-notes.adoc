...
:page-aliases: api-gateway-2.1.0-release-notes.adoc
...
* AGW-412: On link:/api-manager/api-auto-discovery[API Autodiscovery], add a flag to allow the possibility to disable API creation.
