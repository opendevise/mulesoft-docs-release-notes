= Mule Maven Plugin 3.1.6 Release Notes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-aliases: mule-maven-plugin-3.1.6-release-notes.adoc

Mule Maven Plugin 3.1.6 is mainly focused in fixing bugs.
...
* MMP-408 - Cannot package an app using XML module
