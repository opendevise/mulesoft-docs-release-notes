...
:page-aliases: anypoint-data-gateway-release-notes.adoc
...
For more information, see the product https://www.mulesoft.com/press-center/anypoint-data-gateway[announcement].
...
We are excited to release the first version of Anypoint Data Gateway, built for https://www.youtube.com/watch?v=OZWneVt_1Mk[Salesforce Lightning Connect]! You can install this product from https://appexchange.salesforce.com[Salesforce AppExchange].
...
For known issues, see xref:data-gateway::troubleshooting-data-gateway.adoc[Troubleshooting Data Gateway].