...
*Guide:* xref:exchange::to-deploy-using-rest-connect.adoc[Convert a RAML to a Connector Using REST Connect]
...
*Note:* Information on the September 2018 update to Exchange's use of REST Connect is available at xref:exchange/anypoint-exchange-release-notes.adoc[Anypoint Exchange Release Notes].
